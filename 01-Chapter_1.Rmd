...
Let us now try to write a function that put together all the things we did in the previous paragraphs, which is creating the placeholder, running the loop and generating the plot.
...
Let us now test our function `my_fun()`. We assume that the investment lasts for 10 years. We also assume different values of the interest rate from 1\% to 5\%. We use the `seq()` function to generate the numbers of the interest rates.  
